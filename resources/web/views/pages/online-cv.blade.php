...
<x-web::layout class="bg-gradient-to-br from-base-100 to-primary h-92-screen overflow-auto relative fixed" without-footer>
    <div class="container mx-auto px-8 sm:px-4 relative">
        ...
        <div class="relative">
            <div class="grid grid-cols-1 md:grid-cols-7 lg:grid-cols-12 gap-8 relative">
                ...
                <div class="md:col-span-4 lg:col-span-9 mt-0 md:mt-36 flex flex-col items-center lg:items-end gap-y-4" x-data="{ activeTab: 'about' }">

                    <x-web::card class="w-full xl:w-1/3">
